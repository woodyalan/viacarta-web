  ...
  export default {
    ...
    asyncComputed: {
      tableData() {
        ...
        return this.service.get(tiposOcorrencia => tiposOcorrencia);
      }
    },
    data () {
      return {
        title: 'Cadastro de Tipos de Ocorrência',
        description: "Tipos de Ocorrência Cadastrados",
        route: "/cadastros/tipoOcorrencia",
        tableColumns: [
          {
            prop: 'id',
            label: '#',
    ...
    methods: {
      deleteItem(item) {
        ...
        swal({
          ...
          app.service = new TipoOcorrenciaService(app.$resource);
          app.service
