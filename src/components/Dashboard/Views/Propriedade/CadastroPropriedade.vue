      ...
      if (this.validateCep(cep)) {
        this.consultaCep(cep).then(result => {
          ...
          if (result.valid) {
            ...
            this.imovel.endereco = result.logradouro;
            this.imovel.bairro = result.bairro;
            this.imovel.municipio = result.cidade;
            this.imovel.uf = result.estado;
      ...
      if (this.validateCep(cep)) {
        this.consultaCep(cep).then(result => {
          ...
          if (result.valid) {
            ...
            this.proprietario.endereco = result.logradouro;
            this.proprietario.bairro = result.bairro;
            this.proprietario.municipio = result.cidade;
            this.proprietario.uf = result.estado;
          }
        });
      }
    },
    updateCoordinates(location) {
      this.imovelFichaCadastro.latitude = location.latLng.lat();
      this.imovelFichaCadastro.latitude = location.latLng.lng();
    },
    validate() {
