...
import PlanoTrabalho from 'src/domain/planoTrabalho/PlanoTrabalho'
        ...
        .then(success => {
          if(success && !this.loading) {
            ...
            if(this.$route.params.id) {
              this.service
                .update(this.$route.params.id, this.planoTrabalho)
                .then(response => {
  ...
  mounted() {
    ...
    if(this.$route.params.id) {
      ...
      this.service
        ...
        .then(planoTrabalho => this.planoTrabalho = planoTrabalho);
    }
  }
}
</script>
